...
const SAMPLE_IMAGE = "https://images.unsplash.com/photo-1568605114967-8130f3a36994?auto=format&fit=crop&w=1200&q=80";
  ...
  useEffect(() => {
    ...
    const onMessage = (e: MessageEvent) => {
      const data = e.data as
        | { type?: string; section?: string; patch?: WatermarkProps }
        | null;
      if (
        !data ||
        typeof data !== "object" ||
    ...
    <div className="flex flex-col items-center gap-6 px-6 py-12">
      ...
      <div className="relative aspect-[4/3] w-full max-w-2xl overflow-hidden rounded-xl border border-gray-200 bg-gray-100 shadow-md">
        ...
        {enabled && watermarkSrc && (
          ...
          >
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={watermarkSrc} alt="" className="h-auto w-full object-contain" />
          </div>
        )}
        {!enabled && (
