...
export function PreviewAboutClient({
  ...
  useEffect(() => {
    ...
    const onMessage = (e: MessageEvent) => {
      const data = e.data as
        | { type?: string; section?: string; patch?: Partial<AboutProps> }
        | null;
      if (
        !data ||
        typeof data !== "object" ||
  ...
  if (props.kpi1Name && props.kpi1Data) kpis.push({ name: props.kpi1Name, data: props.kpi1Data });
  if (props.kpi2Name && props.kpi2Data) kpis.push({ name: props.kpi2Name, data: props.kpi2Data });
  if (props.kpi3Name && props.kpi3Data) kpis.push({ name: props.kpi3Name, data: props.kpi3Data });
  if (props.kpi4Name && props.kpi4Data) kpis.push({ name: props.kpi4Name, data: props.kpi4Data });

  return (
    <section className="pb-12 pt-12 pl-6 pr-4 sm:pb-16 sm:pl-10 lg:pb-24 lg:pl-16" id="about">
      <div className="container">
        <AboutHeader title={props.title ?? ""} subtitle={props.subtitle ?? ""} />
        ...
        <AboutButton text={props.buttonName ?? "Contacta a Nuestro Equipo"} href="#contact" />
